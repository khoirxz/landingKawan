...
function Services({
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Dashboard - Services" }),
    /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "overflow-hidden bg-white shadow-sm sm:rounded-lg", children: [
      /* @__PURE__ */ jsx("div", { className: "flex px-6 pt-6 justify-end", children: /* @__PURE__ */ jsx(Link, { href: route("services.create"), children: /* @__PURE__ */ jsx(Button, { children: "Tambah" }) }) }),
      /* @__PURE__ */ jsx("div", { className: "p-6 flex", children: /* @__PURE__ */ jsx(Input, { placeholder: "Cari...", className: "text-lg" }) }),
      /* @__PURE__ */ jsx("div", { className: "px-6 my-6 space-y-5", children: services.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-center text-gray-500", children: "No services found" }) : services.map((services2) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
              "img",
              {
                src: `http://127.0.0.1:8000/storage/${services2.image}`,
                alt: "Img",
                className: "w-44 h-32 object-cover"
              }
            ) }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col", children: [
              /* @__PURE__ */ jsx("h1", { className: "text-xl font-semibold", children: services2.name }),
              /* @__PURE__ */ jsx("p", { className: "text-gray-500", children: services2.description.length > 100 ? `${services2.description.slice(
                0,
                100
