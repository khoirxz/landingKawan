...
function Branch({
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "overflow-hidden bg-white shadow-sm sm:rounded-lg", children: [
      /* @__PURE__ */ jsx("div", { className: "flex px-6 pt-6 justify-end", children: /* @__PURE__ */ jsx(Link, { href: route("branches.create"), children: /* @__PURE__ */ jsx(Button, { children: "Tambah" }) }) }),
      ...
      /* @__PURE__ */ jsx("div", { className: "px-6 my-6 space-y-5", children: /* @__PURE__ */ jsxs(Table, { children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { children: branches.length === 0 ? /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(
          TableCell,
          {
            colSpan: 3,
        ...
        ) }) : branches.map((branch) => /* @__PURE__ */ jsxs(TableRow, { children: [
          /* @__PURE__ */ jsx(TableCell, { children: branch.name.slice(0, 20) + (branch.name.length > 20 ? "..." : "") }),
          /* @__PURE__ */ jsx(TableCell, { children: branch.address.slice(0, 20) + (branch.address.length > 20 ? "..." : "") }),
